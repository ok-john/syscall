...
pub mod linux_syscall {
    use std::arch::asm;
    pub fn darwin_syscall_3(syscall: u64, arg1: u64, arg2: u64, arg3: u64) -> i64 {
        unsafe {
            let res;
            asm!(
                "syscall",
...
#[cfg(test)]
mod tests {
    // use crate::syscall_linux;
    use crate::syscalls;
    use super::linux_syscall::{syscall_3, syscall_6};
    ...
    #[test]
    #[cfg_attr(not(feature = "linux"), ignore)]
